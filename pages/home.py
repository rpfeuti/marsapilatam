...
st.markdown(
    ...
    f"| 📃 Deal Information | {t('app.demo_dealinfo')} |\n"
    f"| 💱 {t('swaps.page_title')} | {t('app.demo_swaps')} |\n"
    f"| 💵 FX Options | {t('app.demo_fx')} {t('app.coming_soon')} |\n"
    f"| 🏦 Portfolio | {t('app.demo_portfolio')} {t('app.coming_soon')} |\n"
    f"| 🚀 Swaps Async | {t('app.demo_async')} {t('app.coming_soon')} |"
)
